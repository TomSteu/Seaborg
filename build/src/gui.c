...
void seaborg_seaborg_application_schedule_evaluation (SeaborgSeaborgApplication* self, SeaborgICellContainer* container) {
	SeaborgEvaluationCell* eva = NULL;
	gint last = 0;
	gint _tmp74_;
	gint _tmp75_;
	...
	SeaborgICellContainer* _tmp90_;
	GArray* _tmp91_;
	GArray* _tmp92_;
	gpointer* _tmp93_;
	gint _tmp93__length1;
	gint _tmp94_;
	SeaborgICell* _tmp95_;
	SeaborgICellContainer* _tmp96_;
	SeaborgICellContainer* _tmp97_;
	GArray* _tmp98_;
	GArray* _tmp99_;
	gpointer* _tmp100_;
	gint _tmp100__length1;
	gint _tmp101_;
	SeaborgICell* _tmp102_;
	GError * _inner_error_ = NULL;
	g_return_if_fail (self != NULL);
				...
				i = 0;
				{
					...
					while (TRUE) {
						...
						if (_tmp20_) {
							...
							SeaborgEvaluationCell* _tmp49_;
							gint _tmp50_;
							SeaborgEvaluationCell* _tmp51_;
							gchar* _tmp52_;
							gchar* _tmp53_;
							gboolean _tmp54_;
							gboolean _tmp55_;
							...
							_tmp49_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp48_, SEABORG_TYPE_EVALUATION_CELL, SeaborgEvaluationCell));
							_g_object_unref0 (eva);
							eva = _tmp49_;
							_tmp50_ = i;
							last = _tmp50_;
							_tmp51_ = eva;
							_tmp52_ = seaborg_icell_get_text ((SeaborgICell*) _tmp51_);
							_tmp53_ = _tmp52_;
							_tmp54_ = seaborg_check_input_packet (_tmp53_);
							_tmp55_ = _tmp54_;
							_g_free0 (_tmp53_);
							if (_tmp55_) {
								SeaborgEvaluationCell* _tmp56_;
								SeaborgEvaluationCell* _tmp57_;
								GQueue* _tmp58_;
								SeaborgEvaluationCell* _tmp59_;
								SeaborgEvaluationCell* _tmp60_;
								gchar* _tmp61_;
								gchar* _tmp62_;
								gchar* _tmp63_;
								gchar* _tmp64_;
								...
								gchar* _tmp68_;
								gchar* _tmp69_;
								SeaborgEvaluationData _tmp70_ = {0};
								SeaborgEvaluationData _tmp71_;
								SeaborgEvaluationData* _tmp72_;
								_tmp56_ = eva;
								seaborg_icell_set_lock ((SeaborgICell*) _tmp56_, TRUE);
								_tmp57_ = eva;
								seaborg_evaluation_cell_remove_text (_tmp57_);
								_tmp58_ = self->priv->eval_queue;
								_tmp59_ = eva;
								_tmp60_ = eva;
								_tmp61_ = seaborg_icell_get_text ((SeaborgICell*) _tmp60_);
								_tmp62_ = _tmp61_;
								_tmp63_ = seaborg_replace_characters (_tmp62_);
								_tmp64_ = _tmp63_;
								_tmp65_ = seaborg_replace_plot_input (_tmp64_);
								_tmp66_ = _tmp65_;
								_tmp67_ = g_strconcat ("ToString[" SEABORG_PARAMETER_form "[", _tmp66_, NULL);
								_tmp68_ = _tmp67_;
								_tmp69_ = g_strconcat (_tmp68_, "]]", NULL);
								memset (&_tmp70_, 0, sizeof (SeaborgEvaluationData));
								_tmp70_.cell = (void*) _tmp59_;
								_g_free0 (_tmp70_.input);
								_tmp70_.input = _tmp69_;
								_tmp71_ = _tmp70_;
								_tmp72_ = _seaborg_evaluation_data_dup0 (&_tmp71_);
								g_queue_push_tail (_tmp58_, _tmp72_);
								seaborg_evaluation_data_destroy (&_tmp71_);
								_g_free0 (_tmp68_);
								_g_free0 (_tmp66_);
								_g_free0 (_tmp64_);
								_g_free0 (_tmp62_);
	...
	if ((_tmp75_ + 1) >= _tmp79__length1) {
		...
		_tmp82_ = container;
		_tmp83_ = newCell;
		_tmp84_ = _g_object_ref0 ((SeaborgICell*) _tmp83_);
		_tmp85_ = g_new0 (SeaborgICell*, 1 + 1);
		_tmp85_[0] = _tmp84_;
		_tmp86_ = _tmp85_;
		_tmp86__length1 = 1;
		seaborg_icell_add_before ((SeaborgICell*) _tmp82_, -1, _tmp86_, 1);
		_tmp86_ = (_vala_array_free (_tmp86_, _tmp86__length1, (GDestroyNotify) g_object_unref), NULL);
		_tmp87_ = newCell;
		seaborg_icell_focus_cell ((SeaborgICell*) _tmp87_);
		_tmp88_ = container;
		seaborg_icell_recursive_untoggle_all ((SeaborgICell*) _tmp88_);
		_tmp89_ = newCell;
		seaborg_icell_toggle_all ((SeaborgICell*) _tmp89_);
		_g_object_unref0 (eva);
		return;
	}
	_tmp90_ = container;
	_tmp91_ = seaborg_icell_container_get_Children (_tmp90_);
	_tmp92_ = _tmp91_;
	_tmp93_ = _tmp92_->data;
	_tmp93__length1 = (gint) _tmp92_->len;
	_tmp94_ = last;
	_tmp95_ = _tmp93_[_tmp94_ + 1];
	seaborg_icell_focus_cell (_tmp95_);
	_tmp96_ = container;
	seaborg_icell_recursive_untoggle_all ((SeaborgICell*) _tmp96_);
	_tmp97_ = container;
	_tmp98_ = seaborg_icell_container_get_Children (_tmp97_);
	_tmp99_ = _tmp98_;
	_tmp100_ = _tmp99_->data;
	_tmp100__length1 = (gint) _tmp99_->len;
	_tmp101_ = last;
	_tmp102_ = _tmp100_[_tmp101_ + 1];
	seaborg_icell_toggle_all (_tmp102_);
	_g_object_unref0 (eva);
}
